    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('schoolLogoImage', models.ImageField(blank=True, help_text='optional logo (max 2 MB)', null=True, upload_to='school_logo')),
                ('dateOnboard', models.DateTimeField(auto_now_add=True)),
                ('userAccount', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='onboarded_school', to=settings.AUTH_USER_MODEL)),
            ],
            options={
